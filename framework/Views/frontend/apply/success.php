<div class="success">
	<div class="success-banner bg-dark position-relative w-100">
		<?php require FRONTEND_PATH . DS . "layouts" . DS . "navbar.php"; ?>
		<div class="banner-content">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-12 col-md-10 col-lg-8 mb-5">
						<h1 class="text-white font-weight-bolder text-center mb-3" data-aos="fade-down">Registration <span class="text-orange">Successful</span></h1>
						<p class="text-white text-center">Your registration was successfull. Please follow the steps below carefully.</p>
					</div>
				</div>
			</div>
		</div>
